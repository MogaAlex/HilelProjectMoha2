...
class EcommerceJWTAuthentication(BaseAuthentication):
    def authenticate(self, request):
        ...
        if prefix not in JWT_SETTINGS.get('AUTH_HEADER_TYPES',('Hillel', )):
            return None
        try:
            ...
            raise AuthenticationFailed('Token invalid, try again', code='invalid_token')
        ...
        try:
            ...
            user = User_objects.get(**user_payload)
